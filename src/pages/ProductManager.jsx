...
import { Plus, Edit3, Trash2, Search, X, Upload, Tag, DollarSign, Package, ImageIcon, Star, Eye } from 'lucide-react';
...
const ProductForm = ({ product, onSubmit, onCancel, loading }) => {
  ...
  const categories = [
    'Almonds', 'Cashews', 'Walnut', 'Raisins', 'Pistachio', 'Mixed Fruits',
    'Prunes', 'Dried Mango', 'Dried Kiwi', 'Pine Nuts Without Shell',
    'Dry Apricots', 'Apricot Turkel', 'Makhana', 'Hazelnuts', 'Brazil Nuts',
    'Pecan Nuts', 'Anjeer', 'Macadamia Nuts'
  ];
...
const ProductManagementSystem = () => {
  const { error, addProduct, updateProduct, deleteProduct,getAllProducts } = useProduct();
